  ...
  return (
    ...
    <nav className={`navbar navbar-expand-lg ${mode.background}`}>
      <div className="container-fluid">
        ...
        <a className={`navbar-brand ${mode.color}`} href="#">{props.title}</a>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              ...
              <a className={`nav-link active ${mode.color}`} aria-current="page" href="#">Home</a>
            </li>
            {/* <li className="nav-item"> */}
              {/* <Link className={`nav-link ${mode.color}`} to="/about">About</Link> */}
              {/* <a className={`nav-link ${mode.color}`} href="#">About</a>
            </li> */}
          </ul>
